...
如果有必要我会继续在这个文件中整理你遇到的问题，并给出一定的解决方法。  
**但是一切的前提是你能做到遇到问题的时候会提问和说明，这正是你需要学习的。**
...
### Git安装
**我强烈建议你看完以下两个视频之后继续本教程**
参考网址：  
[给香蕉的Git教程](https://www.bilibili.com/video/BV1Hkr7YYEh8/)
[怎么和呆瓜香蕉一起写代码](https://www.bilibili.com/video/BV1udEuzrEa7/)
...
首先，把你的电脑上安装好 Git，并且克隆这个仓库到本地。之后在 VS Code 里打开这个仓库，按照上面的提问模板来描述你的问题和修改内容。
你需要先上传你的代码文件到这个仓库里，才能在这个仓库里提问和修改。你可以把代码文件放在这个仓库的根目录下，或者创建一个新的文件夹来存放你的代码文件。

**快速开始**

打开[本仓库链接](https://github.com/LiuyiRigel/Hu)  
或  
在你想要的目录下打开右键打开**Git Bash**，输入以下命令来克隆本仓库
> git clone https://github.com/LiuyiRigel/Hu.git

随后在 VS Code 里打开这个仓库，按照上面的提问模板来描述你的问题和修改内容。

**Python 报错常见问题**
```bash
报错：ModuleNotFoundError: No module named 'banana1'
原因：没有安装指定的 Python 包。
...
选择你的环境
conda activate banana-env  #（这里的环境名应该是你自己想要激活的环境名）
